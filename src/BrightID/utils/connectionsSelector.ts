...
import { selectAllConnections } from 'BrightID/reducer/connectionsSlice';
import { toSearchString } from 'BrightID/utils/strings';
import { sortConnectionsBy } from 'BrightID/utils/sorting';
